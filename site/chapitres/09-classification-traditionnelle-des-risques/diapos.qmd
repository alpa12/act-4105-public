...
# Définitions {data-progress-label="Défs" subtitle="Variables, classes et différentiels utilisés pour segmenter les risques"}
...
# Importance des taux équitables {data-progress-label="Taux équitables" subtitle="Une tarification proportionnée au risque de chaque classe"}
...
|  |  |
|:--|:--|
| ![](assets/homme-caverne.svg){width=72px fig-alt=""} | **Assureur A** : tarification très simple. Prime unique de 150 $ pour tous |
| ![](assets/reflexion.svg){width=72px fig-alt=""} | **Assureur B** : tarification très segmentée. Prime de 200 $ pour les risques élevés et de 100 $ pour les risques faibles |
...
![](assets/assureur-a-t1.png){width=65% fig-alt="Chez l'assureur A, trois risques faibles sont encerclés parmi les dix véhicules du portefeuille initial."}
...
![](assets/assureur-b-t1.png){width=65% fig-alt="Chez l'assureur B, trois risques élevés sont encerclés parmi les dix véhicules du portefeuille initial."}
...
# Critères d’évaluation des variables de tarification {data-progress-label="Critères" subtitle="Des variables pertinentes, crédibles, pratiques et acceptables"}
...
::: {.aside}
Sources : [Autorité ontarienne de réglementation des services financiers](https://www.fsrao.ca/fr/pour-le-secteur/assurance-automobile/cadre-de-reglementation/lignes-directrices-assurance-automobile/revue-annuelle-de-lontario-visant-les-vehicules-de-tourisme-fondee-sur-les-donnees-de-lindustrie-au-31-decembre-2023) et [Board of Commissioners of Public Utilities de Terre-Neuve-et-Labrador](https://www.pub.nf.ca/AutoInsurance/QA/AI_faq15.php)
:::
...
::: {.callout-warning}
**Attention** : le numérateur et le dénominateur doivent être au niveau projeté et ultime.
:::

:::
::::

Ici, $R1_{I,i}$ est le différentiel indiqué pour le niveau $i$ de la variable de tarification $R1$. Par exemple, si $i$ est le niveau « Région Montréal », alors $R1_{I,i}$ est le différentiel indiqué pour la région de Montréal.
...
$$
\bar{R}_{\text{montant},t} =
\frac{\sum_m X_{m,t} R_m}{\sum_m X_{m,t}}
$$
